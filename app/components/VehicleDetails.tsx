  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-8">
      ...
      <div className="flex flex-col ml-4 items-center md:items-start">
        ...
        <dl className="max-w-lg md:max-w-unset grid grid-cols-4 gap-12 mt-4">
          <div>
            <dt className="text-sm text-gray-600">Year</dt>
            <dd>{vehicle.year}</dd>
          </div>
          <div>
            <dt className="text-sm text-gray-600">Price/hour</dt>
            <dd>{(vehicle.hourly_rate_cents / 100).toFixed(2)} $</dd>
          </div>
          <div>
